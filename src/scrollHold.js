 ...
 * AFTER our restore. Whoever lands last wins, which is exactly why the failure
 * was intermittent for identical actions. `history.scrollRestoration = 'manual'`
 * does not prevent it.
 */
export function holdScrollAt(target) {
  ...
  // that, so it would abort us instantly. touch/wheel/key are what a person does.
